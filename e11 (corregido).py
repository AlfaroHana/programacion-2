#Antes si tenías menos de lo que el cliente pedía el programa tomaba la cantidad de todas formas y después marcaba un menos.
#Pero si sí tenia el stock para lo que el cliente pedía, marcaba error. Solamente tuve que cambiar el "<" y poner un ">=" para que cuando el cliente pidiera x cantidad y sí hubiera continuara el código.
#Sino que marcara el error de stock insuficiente.
...
def procesar_inventario():
    ...
    for i in range(len(productos)):
        ...
        if stock_actual >= cantidad_pedida: #aca estaba el error :D 
